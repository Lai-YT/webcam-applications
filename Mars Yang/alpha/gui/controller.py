...
class GuiController:
    ...
    def _enable_buttons(self):
        ...
        self._gui.action_buttons["Restart"].clicked.connect(
            partial(self._gui.action_buttons["Restart"].setEnabled, False)
        )
        self._gui.action_buttons["Restart"].clicked.connect(
    ...
    def _connect_actions(self):
        ...
        self._gui.action_buttons["Exit"].clicked.connect(self._exit)
