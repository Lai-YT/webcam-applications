...
# Auto grade membership function.
...
rule1 = ctrl.Rule(body["poor"], grade["poor"])
rule2 = ctrl.Rule(blink["average"] | body["average"], grade["average"])
rule3 = ctrl.Rule(blink["good"] | body["good"], grade["good"])
