...
class SettingController:
    ...
    def _check_and_save(self):
        ...
        if passed:
            # Parameters adjustion confirmed.
            self._widget.warning_message.clear()
            self._widget.save_message.setText("Saved!")
            self._store_configs()
        else:
            # Warning when parameters are out of range.
            self._widget.save_message.clear()
            self._widget.warning_message.setText("error: parameter out of range")
